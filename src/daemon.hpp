...
inline const char* cmdToString(eFlatSatCommands cmd) {
    switch (cmd) {
        case CMD_TRACK_SENSOR: return "track sensor"; break;
        case CMD_UNTRACK_SENSOR: return "untrack sensor"; break;
        case CMD_REGISTER_SENSOR: return "register sensor"; break;
        case CMD_UNREGISTER_SENSOR: return "unregister sensor"; break;
        case CMD_SET_MEASUREMENT_PERIOD: return "set measurement period"; break;
        default: break;
    }
    return "";
};
